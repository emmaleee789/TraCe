...
class GaussianBaseModel(BaseGeometry, GaussianIO):
    ...
    class Config(BaseGeometry.Config):
        max_num: int = 500000
        sh_degree: int = 0
        position_lr: Any = 00005 # 0.001
        scale_lr: Any = 0.005 # 0.003
        feature_lr: Any = 0.01
        opacity_lr: Any = 0.01 # 0.05
        scaling_lr: Any = 0.005
        rotation_lr: Any = 0.001 # 0.005
        pred_normal: bool = False
        normal_lr: Any = 0.005 # 0.001

        densification_interval: int = 100 # 50
        prune_interval: int = 100 # 50
        opacity_reset_interval: int = 100000
        densify_from_iter: int = 300 # 100
        prune_from_iter: int = 300 # 100
        densify_until_iter: int = 900 # 2000
        prune_until_iter: int = 900 # 2000
        densify_grad_threshold: Any = 0.005
        min_opac_prune: Any = 0.005
        split_thresh: Any = 0.04 # 0.02
